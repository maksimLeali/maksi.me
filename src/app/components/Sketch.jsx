...
const HexagonCollisionGSAP = () => {
    ...
    useEffect(() => {
        ...
        const hexaLeft = pg_size > 820 ? 38 : 26;
        const hexaTop = 20;
        ...
        class Hexagon {
            ...
            getIntersectionArea(otherHex) {
                ...
                const thisPointsWithinOther =
                    this.computeWorldCoordinates().filter((p) =>
                        otherHex.checkIfPointWithin(p),
                    );
        ...
        function render() {
            ...
            for (let i = 0; i < hexagons.length; i++) {
                for (let j = i + 1; j < hexagons.length; j++) {
                    const polyPoints = hexagons[i].getIntersectionArea(
                        hexagons[j],
                    );
                    if (polyPoints) {
                        ctx.save();
        ...
        <>
            ...
            <WordsContainer>
                ...
                >
                    <clipPath id="p.0">
                        <path
                            d="m0 0h755.9055v755.9055h-755.9055z"
                            clipRule="nonzero"
                        />
                    </clipPath>
                    <g clipPath="url(#p.0)">
